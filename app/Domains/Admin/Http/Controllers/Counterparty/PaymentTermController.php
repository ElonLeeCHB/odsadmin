...
class PaymentTermController extends BackendController
{
    ...
    public function index()
    {
        ...
        $data['delete_url'] = route('lang.admin.common.payment_terms.delete');
    ...
    public function delete()
    {
		...
		if (!$json) {
			...
			foreach ($selected as $payment_term_id) {
				$result = $this->PaymentTermService->deletePaymentTerm($payment_term_id);
