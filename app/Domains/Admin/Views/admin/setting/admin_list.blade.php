<form id="form-user" method="post" data-oc-toggle="ajax" data-oc-load="{{ $listUrl }}" data-oc-target="#user">
	@csrf
	@method('POST')
		...
		<table class="table table-bordered table-hover">
			...
			<tbody>
				...
				<tr>
					...
					<td class="text-start d-none d-lg-table-cell">{{ $row->created_date }}</td>
	...
	{!! $users->links('admin.pagination.default', ['users'=>$users]) !!}
