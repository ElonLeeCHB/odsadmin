	...
	<div class="page-header">
		<div class="container-fluid">
			<div class="float-end">
				...
				<a href="{{ $newUrl }}" data-bs-toggle="tooltip" title="Add New" class="btn btn-primary"><i class="fas fa-plus"></i></a>
				<?php /*<button type="submit" form="form-user" formaction="{{ route('lang.admin.user.users.massdelete') }}" data-bs-toggle="tooltip" title="Delete" onclick="return confirm('Are you sure?');" class="btn btn-danger"><i class="fas fa-trash-alt"></i></button> */ ?>
			</div>
  ...
  <div class="container-fluid">
	<div class="row">
	  <div id="filter-user" class="col-lg-3 col-md-12 order-lg-last d-none d-lg-block mb-3">
		...
		<?php /*
        <div class="mb-3">
          <label class="form-label">{{ $lang->column_location }}</label>
          <input type="text" name="filter_company" value="" id="input-company" list="list-company" class="form-control"/>
