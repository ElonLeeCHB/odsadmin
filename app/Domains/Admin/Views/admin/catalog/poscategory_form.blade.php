            ...
            <div class="tab-content">
              ...
              <div id="tab-general" class="tab-pane">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <div class="input-group">
                      <input type="text" id="input-comment" name="comment" value="{{ $poscategory->comment }}" class="form-control">
                    </div>
                  ...
                  <div class="col-sm-10">
                    <div class="input-group">
                      <div id="input-is_active" class="form-check form-switch form-switch-lg">
                        ...
                        <input type="checkbox" name="is_active" value="1" class="form-check-input" @if($poscategory->is_active) checked @endif/>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <input type="hidden" id="input-poscategory_id" name="poscategory_id" value="{{ $poscategory_id }}"/>
            </div>
          </form>
          </div>
          </div>
...
$('#input-parent_name').autocomplete({
  'source': function (request, response) {
    ...
    $.ajax({
      url: "{{ $autocomplete_url }}?filter_name=" + encodeURIComponent(request) + '&equal_taxonomy_code=product_category' + '&exclude_id=' + self_id,
      dataType: 'json',
