...
<div id="content">
  <div class="page-header">
    <div class="container-fluid">
      <div class="float-end">
        <button type="button" id="btn-export_daily_list" data-bs-toggle="tooltip" data-loading-text="Loading..." title="下載備料表(日匯總)" class="btn btn-info" aria-label="下載備料表(日匯總)"><i class="fas fa-file-export"></i></button>
...
$('#btn-export_daily_list').on('click', function () {
  ...
  $.ajax({
      ...
      success: function(data)
      {
        ...
        link.download = '備料表日匯總_'+now_string+'.xlsx';
        link.click();
      },
      complete: function () {
