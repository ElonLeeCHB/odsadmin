      ...
      <div class="card-body">
        ...
        <div class="tab-content">
          <div id="tab-general" class="tab-pane active">
            <form id="form-mrequisition" method="post" data-oc-toggle="ajax">
              @csrf
              @method('POST')
              <div class="tab-content">
                <div id="tab-general" class="tab-pane active">
...
function redirectToDate(id){
  ...
  if(required_date_2ymd.length > 0){
    ...
    if(id == 'btn-redirectToRequiredDateUpdate'){
      url += '?force=1';
    }
...
$("#btn-redirectToRequiredDate").on('click', function(){
  redirectToDate('btn-redirectToRequiredDate');
});
$("#btn-redirectToRequiredDateUpdate").on('click', function(){
  redirectToDate('btn-redirectToRequiredDateUpdate');
});
