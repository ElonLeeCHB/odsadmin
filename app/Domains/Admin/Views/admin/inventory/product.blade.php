	...
	<div class="page-header">
		<div class="container-fluid">
			<div class="float-end">
				...
				<a href="{{ route('lang.admin.catalog.products.form') }}" data-bs-toggle="tooltip" title="Add New" class="btn btn-primary"><i class="fas fa-plus"></i></a>
				<?php /*<button type="submit" form="form-product" formaction="{{ route('lang.admin.catalog.products.massdelete') }}" data-bs-toggle="tooltip" title="Delete" onclick="return confirm('Are you sure?');" class="btn btn-danger"><i class="fas fa-trash-alt"></i></button> */ ?>
			</div>
	  ...
	  <div id="filter-product" class="col-lg-3 col-md-12 order-lg-last d-none d-lg-block mb-3">
		...
		<div class="card">
		  ...
		  <div class="card-body">
					...
					<div class="mb-3">
						<label class="form-label">{{ $lang->entry_is_salable }}</label>
