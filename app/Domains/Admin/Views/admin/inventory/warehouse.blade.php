...
<div id="content">
  <div class="page-header">
    <div class="container-fluid">
      <div class="float-end">
        <button type="button" data-bs-toggle="tooltip" title="{{ $lang->button_filter }}" onclick="$('#filter-warehouse').toggleClass('d-none');" class="btn btn-light d-md-none d-lg-none"><i class="fa-solid fa-filter"></i></button>
        <a href="{{ $add_url }}" data-bs-toggle="tooltip" title="{{ $lang->button_add }}" class="btn btn-primary"><i class="fa-solid fa-plus"></i></a>
        <button type="submit" form="form-warehouse" formaction="{{ $delete_url }}" data-bs-toggle="tooltip" title="{{ $lang->button_delete }}" onclick="return confirm('{{ $lang->text_confirm }}');" class="btn btn-danger"><i class="fa-regular fa-trash-can"></i></button>
      </div>
  ...
  <div class="container-fluid">
    <div class="row">
      <div id="filter-warehouse" class="col-lg-3 col-md-12 order-lg-last d-none d-lg-block mb-3">
        <form>
          <div class="card">
      ...
      <div class="col-lg-9 col-md-12">
        <div class="card">
          ...
          <div id="warehouse" class="card-body">{!! $list !!}</div>
        </div>
      </div>
    </div>
  </div>
...
$('#warehouse').on('click', 'thead a, .pagination a', function(e) {
	e.preventDefault();

	$('#warehouse').load(this.href);
});
