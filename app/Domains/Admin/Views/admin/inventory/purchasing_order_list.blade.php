<form id="form-order" method="post" data-oc-toggle="ajax" data-oc-load="{{ route('lang.admin.sale.orders.list') }}" data-oc-target="#order">
    ...
    <table class="table table-bordered table-hover">
      <thead>
        <tr>
          ...
          <td class="text-start"><a href="{{ $sort_purchasing_date }}" @if($sort=='purchasing_date') class="{{ $order }}" @endif>{{ $lang->column_purchasing_date }}</a></td>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="text-start">{{ $row->purchasing_date }}</td>
  ...
  {!! $purchasing_orders->links('admin.pagination.default') !!}
</form>