      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div class="mb-3">
            ...
            <option value="">--</option>
              @foreach($purchasing_order_statuses as $status)
          ...
          <div class="mb-3">
            <label data-bs-toggle="tooltip" title="2023-02-20 或不加橫線 20230220 或範圍 20230301-20230331 或大於某日 >20230101 或小於某日 <20230101" style="font-weight: bolder;" >採購日期 <i class="fa fa-question-circle" aria-hidden="true"></i></label>
            <input type="text" name="filter_purchasing_date" value="" placeholder="例如 2023-02-20" id="input-purchasing_date" class="form-control"/>
          </div>

          <div class="mb-3">
            <label data-bs-toggle="tooltip" title="2023-02-20 或不加橫線 20230220 或範圍 20230301-20230331 或大於某日 >20230101 或小於某日 <20230101" style="font-weight: bolder;" >收貨日期 <i class="fa fa-question-circle" aria-hidden="true"></i></label>
...
$('#button-filter').on('click', function() {
  ...
  var filter_purchasing_date = $('#input-purchasing_date').val();
  if (filter_purchasing_date) {
    url += '&filter_purchasing_date=' + encodeURIComponent(filter_purchasing_date);
  }
