...
namespace App\Domains\ApiPos\Http\Controllers\Catalog;

use Illuminate\Http\Request;
use App\Domains\ApiPos\Http\Controllers\ApiPosController;
use App\Domains\ApiPos\Services\Catalog\CategoryService;
