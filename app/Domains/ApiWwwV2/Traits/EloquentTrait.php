...
namespace App\Domains\ApiWwwV2\Traits;
...
trait EloquentTrait
{
    ...
    */
     ...
     */
    public function getTableColumns($table_name = null, $connection_name = null)
    {
        $table_name = $this->model->getTable();

        return OrmHelper::getTableColumns($table_name, $connection_name);
    }
