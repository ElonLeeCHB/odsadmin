...
class TermObserver
{
    public function saved(Term $term)
    {
        ...
        //     $this->createTermPath($term);
        // } 
        // // 更新
        // else if (!$term->wasRecentlyCreated) {
        //     $this->updateTermPath($term);
        // }

        // ChatGPT
        (new TermRepository)->rebuildTermPaths($term);
    ...
    // 參考 opencart
        // public function updateTermPath(Term $term)
        // {
        //     $term_id = $term->id;
        ...
        // public function createTermPath(Term $term)
        // {
        //     // 處理 term_paths
        //         // 刪除舊的 term_paths
        //         TermPath::where('term_id', $term->id)->delete();
