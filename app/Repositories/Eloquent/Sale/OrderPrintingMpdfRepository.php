...
class OrderPrintingMpdfRepository extends Repository
{    
    ...
    {
        $orders = $this->getOrdersPringtingData([$order_id, 9200]);
    ...
    public function getOrdersPringtingData($order_ids)
    {
        ...
        try {
            ...
            foreach ($order_ids as $order_id) {
                //抓訂單、處理單頭
                    ...
                    if(empty($order)){
                        throw new \Error('找不到訂單：' . $order_id);
                    }
                //
