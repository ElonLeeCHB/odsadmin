...
'column_stock_price' => '庫存單位成本',
'column_usage_price' => '用量單位成本',
'column_comment' => '備註',
...
'column_reward' => '紅利點數',
'column_attribute' => '屬性',
'column_attribute_group' => '屬性群組',
'column_option' => '選項',
'column_option_value' => '選項值',
'column_is_hidden' => '是否隱藏',
'column_is_fixed' => '是否固定版面',
'column_date_available' => '可用日期',
'column_category' => '分類',
'column_points' => '點數',
...
'placeholder_model' => '請輸入英數字或橫線',

// Help
'help_category' => '(自動完成)',
'help_main_category' => '(自動完成)',

// Error
'error_name' => '商品名稱長度必須在 2 到 255 個字！',
'error_meta_title' => 'Meta標題必須在 2 到 255 個字！',
'error_meta_keyword' => 'Meta關鍵字必須在 2 到 255 個字！',
